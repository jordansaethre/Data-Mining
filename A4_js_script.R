...
# The SVM model based on the default settings - rfbdot and C=1 has the best testing performance based of 
# F11 and F12. The SVM model based on laplacedot and C=5 has the best F12. The performance of different 
# kernel functions and different misclassification cost vary by data sets and applications. The Sds are a 
# bit higher for the survived class than for the non-survived class.
